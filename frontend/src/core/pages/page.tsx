  ...
  return (
    <div className="min-h-screen bg-[var(--bg-main)]">
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        {/* Main Grid - High Contrast Light Mode */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16 max-w-4xl mx-auto px-4">
          ...
          >
            ...
            <div className="p-6 text-center bg-white">
              <Utensils className="text-[var(--gold-primary)] w-6 h-6 mx-auto mb-3" />
          ...
          >
            ...
            <div className="p-6 text-center bg-white">
              <Tag className="text-[var(--gold-primary)] w-6 h-6 mx-auto mb-3" />
              <h3 className="text-xl font-bold tracking-[0.2em] text-slate-900 mb-2 uppercase">
                PROMOCIONES
              </h3>
              <div className="w-12 h-0.5 bg-amber-400 mx-auto opacity-40"></div>
          ...
          >
            ...
            <div className="p-6 text-center bg-white">
              <Wine className="text-[var(--gold-primary)] w-6 h-6 mx-auto mb-3" />
              <h3 className="text-xl font-bold tracking-[0.2em] text-slate-900 mb-2 uppercase">
                BEBIDAS PREMIUM
              </h3>
              <div className="w-12 h-0.5 bg-amber-400 mx-auto opacity-40"></div>
          ...
          >
            ...
            <div className="p-6 text-center bg-white">
              <Coffee className="text-[var(--gold-primary)] w-6 h-6 mx-auto mb-3" />
              <h3 className="text-xl font-bold tracking-[0.2em] text-slate-900 mb-2 uppercase">
                POSTRES & CAFÉ
              </h3>
              <div className="w-12 h-0.5 bg-amber-400 mx-auto opacity-40"></div>
